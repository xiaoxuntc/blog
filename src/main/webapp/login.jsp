...
<div>
	<form action="${pageContext.request.contextPath}/blogger/reg.do" method="post">
...
<body>
	...
	<div style="text-align: center; padding-top: 30px">Copyright © 2012-2016 Java知识分享网 版权所有</div>
</body>
</html>